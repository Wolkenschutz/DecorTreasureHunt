...
local L = {
    enUS = {
        ...
        OPTIONS_DESCRIPTION = "Configure auto-accept and auto turn-in for the Decor Treasure Hunt quest.",
    ...
    deDE = {
        ...
        OPTIONS_DESCRIPTION = "Automatische An- und Abgabe für die Dekorationsjagd-Quest konfigurieren.",
